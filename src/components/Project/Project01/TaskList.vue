...
// splice(startIndex, deleteCount) sẽ loại bỏ deleteCount phần tử bắt đầu từ vị trí startIndex.
// deleteCount: Số lượng phần tử sẽ bị loại bỏ từ vị trí startIndex.
